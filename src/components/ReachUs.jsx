      ...
      <div className="reach-inner">
        ...
        <div className="reach-grid">
          ...
          <div className="reach-card">
            ...
            <h3>Email</h3>
            <p><a href="mailto:info@apexhealthcare.co.tz">info@apexhealthcare.co.tz</a></p>
          </div>
          <div className="reach-card">
            <div className="reach-icon-wrap">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <h3>WhatsApp</h3>
            <p><a href="https://wa.me/255123456789" target="_blank" rel="noopener noreferrer">Chat with us</a></p>
          </div>
